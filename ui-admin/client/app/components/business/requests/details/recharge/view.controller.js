((function () {
    ...
    /*@ngInject*/
    function RequestRechargeViewCtrl(common,RequestDetailsSvc,RequestDetailsCluster,RequestsSvc, NotificationsSvc) {
        var vm = this;
        ...
        function approveRequest(request) {
            ...
            request.amount *=100
            RequestsSvc.handlerRecharge(request,true).then(function(res){
        ...
        function rejectRequest(request) {
            //reconver modification to send the amount
            request.amount *=100
            RequestsSvc.handlerRecharge(request,false).then(function(res){
    ...
    angular.module('hiraApp')
        .controller('RequestRechargeViewCtrl', RequestRechargeViewCtrl);
